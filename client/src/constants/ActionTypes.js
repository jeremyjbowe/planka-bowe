...
export default {
  ...
  GOAL_CREATE__SUCCESS: 'GOAL_CREATE__SUCCESS',
  GOAL_CREATE__FAILURE: 'GOAL_CREATE__FAILURE',
  GOAL_CREATE_HANDLE: 'GOAL_CREATE_HANDLE',
  GOAL_UPDATE: 'GOAL_UPDATE',
  GOAL_UPDATE__SUCCESS: 'GOAL_UPDATE__SUCCESS',
  GOAL_UPDATE__FAILURE: 'GOAL_UPDATE__FAILURE',
  GOAL_UPDATE_HANDLE: 'GOAL_UPDATE_HANDLE',
  GOAL_DELETE: 'GOAL_DELETE',
  GOAL_DELETE__SUCCESS: 'GOAL_DELETE__SUCCESS',
  GOAL_DELETE__FAILURE: 'GOAL_DELETE__FAILURE',
  GOAL_DELETE_HANDLE: 'GOAL_DELETE_HANDLE',
  GOAL_LINK_CREATE: 'GOAL_LINK_CREATE',
  GOAL_LINK_CREATE__SUCCESS: 'GOAL_LINK_CREATE__SUCCESS',
  GOAL_LINK_CREATE__FAILURE: 'GOAL_LINK_CREATE__FAILURE',
  GOAL_LINK_CREATE_HANDLE: 'GOAL_LINK_CREATE_HANDLE',
  GOAL_LINK_UPDATE_HANDLE: 'GOAL_LINK_UPDATE_HANDLE',
  GOAL_LINK_DELETE: 'GOAL_LINK_DELETE',
  GOAL_LINK_DELETE__SUCCESS: 'GOAL_LINK_DELETE__SUCCESS',
  GOAL_LINK_DELETE__FAILURE: 'GOAL_LINK_DELETE__FAILURE',
  GOAL_LINK_DELETE_HANDLE: 'GOAL_LINK_DELETE_HANDLE',
  ...
  /* Saved views (planka-bowe) */

  BOARD_FILTERS_UPDATE: 'BOARD_FILTERS_UPDATE',
  BOARD_FILTERS_CLEAR: 'BOARD_FILTERS_CLEAR',
  SAVED_VIEW_APPLY: 'SAVED_VIEW_APPLY',
  SAVED_VIEW_CREATE: 'SAVED_VIEW_CREATE',
  SAVED_VIEW_CREATE__SUCCESS: 'SAVED_VIEW_CREATE__SUCCESS',
  SAVED_VIEW_CREATE__FAILURE: 'SAVED_VIEW_CREATE__FAILURE',
  SAVED_VIEW_CREATE_HANDLE: 'SAVED_VIEW_CREATE_HANDLE',
  SAVED_VIEW_UPDATE: 'SAVED_VIEW_UPDATE',
  SAVED_VIEW_UPDATE__SUCCESS: 'SAVED_VIEW_UPDATE__SUCCESS',
  SAVED_VIEW_UPDATE__FAILURE: 'SAVED_VIEW_UPDATE__FAILURE',
  SAVED_VIEW_UPDATE_HANDLE: 'SAVED_VIEW_UPDATE_HANDLE',
  SAVED_VIEW_DELETE: 'SAVED_VIEW_DELETE',
  SAVED_VIEW_DELETE__SUCCESS: 'SAVED_VIEW_DELETE__SUCCESS',
  SAVED_VIEW_DELETE__FAILURE: 'SAVED_VIEW_DELETE__FAILURE',
  SAVED_VIEW_DELETE_HANDLE: 'SAVED_VIEW_DELETE_HANDLE',
