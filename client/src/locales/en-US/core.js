...
export default {
  ...
  translation: {
    common: {
      ...
      sortableRowsWithColumns: 'Sortable rows with columns for every field.',
      settings: 'Settings',
      shared: 'Shared',
      ...
      linkExistingCard: 'Link existing card',
      noParentCard: 'No parent card',
      parentCard: 'Parent card',
      subtask: 'Subtask',
      subtasks: 'Subtasks',
      subtasksDone: '{{completed}} of {{total}} done',
      subtaskNamePlaceholder: 'What needs to happen first?',
      unlinkSubtask: 'Unlink from parent',
      editRecurrence_title: 'Edit Recurrence',
      recurrenceBiweekly: 'Every 2 weeks',
      recurrenceCustom: 'Custom rule (RRULE)',
      recurrenceDaily: 'Every day',
      recurrenceInvalid: 'This rule could not be parsed.',
      recurrenceMonthly: 'Every month',
      recurrenceNextOccurrenceHint:
        'When this card is completed, the next occurrence is created automatically with the following due date.',
      ...
      home: 'Home',
      noParentProject: 'No parent project',
      noProjectsYet: 'No projects yet',
      parentProject: 'Parent project',
      parentProjectHint:
        'Nest this project under another one. Its boards show up in the sidebar when the parent is expanded.',
      subprojects: 'Sub-projects',
      projects: 'Projects',
      commandPalette: 'Command palette',
      commandPaletteHint:
        'Type to search. Start with a plain sentence to create a card: use @name, #label, !priority, ~project and natural dates like "tomorrow 3pm".',
      createCardNamed: 'Create card "{{name}}"',
      editPriority_title: 'Edit Priority',
      noPriority: 'No priority',
      openBoardToCreateCards: 'Open a board (or add ~project) to create cards.',
      priority: 'Priority',
      priorityHigh: 'High',
      priorityLow: 'Low',
      ...
      goals: 'Goals',
      goalsSubtitle:
        'Objectives that span projects, with progress computed from the cards and boards linked to them.',
      goalName: 'Goal name',
      goalNamePlaceholder: 'What are we trying to achieve?',
      ...
      linkCard: 'Link card',
      noLinksYet: 'Nothing linked yet. Progress is set by hand until you link cards or boards.',
      manualProgress: 'Manual progress',
      progressFromLinks: 'Progress from {{count}} linked item',
      progressFromLinks_other: 'Progress from {{count}} linked items',
      noGoalsYet: 'No goals yet',
      noGoalsHintOwner: 'Goals tie the work on your boards to outcomes. Create the first one.',
      noGoalsHintMember: 'Goals will show up here once an admin or project owner creates them.',
      subgoals: 'Sub-goals',
      deleteGoal: 'Delete goal',
      areYouSureYouWantToDeleteThisGoal:
        'Are you sure you want to delete this goal? Linked cards and boards are not affected.',
      page: 'Page',
      hiddenLinkedItem: 'Item you cannot see',
      ...
      shortcutsCards: 'Cards',
      shortcutsViews: 'Views',
      shortcutsBoard: 'Board',
      shortcutsGlobal: 'Global',
      shortcutsHoverHint:
        'While the pointer rests on a card, h, l and 1\u20139 act on that card instead.',
      shortcutSelectNextCard: 'Select next card',
      shortcutSelectPreviousCard: 'Select previous card',
      shortcutSelectPreviousList: 'Select previous list',
      shortcutSelectNextList: 'Select next list',
      shortcutOpenSelectedCard: 'Open selected card',
      shortcutClearSelection: 'Clear selection',
      shortcutAddCard: 'Add a card to the list',
      shortcutOpenHoveredCard: 'Open card under the pointer',
      shortcutEditCardName: 'Rename card',
      shortcutCardMembers: 'Card members',
      shortcutCardLabels: 'Card labels',
      shortcutArchiveCard: 'Archive card',
      shortcutToggleLabel: 'Toggle label',
      shortcutCopyCard: 'Copy card',
      shortcutCutCard: 'Cut card',
      shortcutPasteCard: 'Paste card',
      shortcutSearchBoard: 'Search this board',
      shortcutPreviousBoard: 'Previous board',
      shortcutNextBoard: 'Next board',
      shortcutCommandPalette: 'Command palette',
      shortcutToggleShortcuts: 'Show keyboard shortcuts',
      ...
      views: 'Views',
      viewName: 'View name',
      shareWithTheBoard: 'Share with the board',
      saveCurrentView: 'Save current view…',
      editView: 'Edit View',
      deleteView_title: 'Delete View',
      areYouSureYouWantToDeleteThisView: 'Are you sure you want to delete this view?',
      noViewsYet: 'No saved views yet',
      sharedView: 'Shared with the board',
      personalView: 'Only you',
      table: 'Table',
      barsOnACalendarForCardsWithDueDates: 'Bars on a calendar for cards with due dates.',
      timeline: 'Timeline',
      timelineEmpty: 'Nothing is scheduled yet.',
      timelineEmptyHint: 'Give a card a due date and it will show up here as a bar you can drag.',
      unscheduled: 'Unscheduled',
      viewModeDay: 'Day',
      viewModeWeek: 'Week',
      viewModeMonth: 'Month',
      tableEmpty: 'No cards match this view yet.',
      tableEmptyHint: 'Add a card or clear the filters to see rows here.',
    ...
    action: {
      ...
      exportAsJson_title: 'Export as JSON',
      import: 'Import',
      join: 'Join',
      leave: 'Leave',
